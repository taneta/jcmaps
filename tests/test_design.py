"""The rules of docs/design.md, checked: colors are tokens, text meets WCAG AA, the site is light only, and the
copies that cannot read CSS (theme-color, manifest, icon) match their tokens."""
import json
import re
