...
- Moved to https://jcmaps.com/ the same day: DNS changed at Squarespace, domain verified for the account, certificate approved within a minute of setting the domain, HTTPS enforced. The github.io address redirects, and `--pull` follows the redirect.
